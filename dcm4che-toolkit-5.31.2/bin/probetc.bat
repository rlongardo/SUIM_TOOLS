...
set MAIN_JAR=dcm4che-tool-probetc-5.31.2.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-conf-api-5.31.2.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-conf-ldap-5.31.2.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-conf-prefs-5.31.2.jar
