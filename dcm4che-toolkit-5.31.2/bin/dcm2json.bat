...
set MAIN_JAR=dcm4che-tool-dcm2json-5.31.2.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-dict-priv-5.31.2.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\dcm4che-json-5.31.2.jar
...
set CP=%CP%;%DCM4CHE_HOME%\lib\jakarta.json-api-2.1.2.jar
set CP=%CP%;%DCM4CHE_HOME%\lib\parsson-1.1.3.jar
